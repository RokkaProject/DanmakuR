...
function fun_FullScreen() {
    ...
    function setFullScreenSize() {
        ...
        setTimeout(function () {
            ...
            DC_Slider.css('width',parseInt(Danmaku.css('width'))-parseInt(Btn_StartPause.css('width'))-parseInt($('.DC_VideoTime').css('width'))-parseInt(Btn_Volume.css('width'))-parseInt(Btn_FullScreen.css('width'))+'px');
            ...
            DC_Input.css('width',parseInt(Danmaku_Controller.css('width'))-parseInt(DC_Btn_Send.css('width'))-parseInt(DC_Btn_Font.css('width'))-1+'px');
